import numpy as np
from scripts import boid_system, world_parameters, sharks, fish, sharks_system, food, spatial_grid
...
class Aquarium():
    def __init__(self):
        ...
        self.boids_calculation = boid_system.BoidSystem() #used for calculation of the 3 boids rules
        self.sharks_calculation = sharks_system.SharkSystem() #used for calculation of the 3 boids rules
    ...
    def simulate_step(self):
        ...
        for fish in self.fishes:
            fish.move(self.boids_calculation, self.sharks_calculation)
